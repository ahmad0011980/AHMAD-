// ============================================
//      AHMII BAJWA BOT — CORE/WHATSAPP.JS
...
⏰ *This code expires in 2 minutes\\!*`;
  ...
  sock.ev.on('connection.update', async (update) => {
    ...
    if (connection === 'close') {
      ...
      const botName   = sock.user?.name || sock.user?.notify || 'AHMII BAJWA';
